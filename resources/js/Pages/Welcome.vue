...
<template>
    ...
    <Navbar :landing="true">
        <header class="masthead-landing p-4 pt-4">
            <img
                src="/assets/img/site-banners/stars-bg.png"
                style="z-index: 1"
                alt="background"
            />
                    ...
                    <div class="row-landing">
                        <div class="text-white">
                            ...
                            <div class="min-w-0 gap-2 mt-3 flex-container">
                                ...
                                >
                                    <i
                                        class="mr-1 fa-duotone fa-person-to-portal show-for-medium"
                                    ></i>
                                    Get Started
                                </Link>
                                <Link
                                    :href="route('auth.login.page')"
                                    class="btn btn-landing btn-info"
                                >
                                    <i
                                        class="mr-1 fa-duotone fa-door-open show-for-medium"
                                    ></i>
                                    Login
                                </Link>
                            </div>
        ...
        <main class="container container-landing">
            <div
                class="justify-center grid-x grid-margin-x align-center grid-padding-y"
            >
                ...
                <div class="cell large-12">
                    ...
                    <div v-else>
                        <div class="card">
                            <div class="card-body">
                                <div
                                    class="gap-2 text-center flex-container flex-dir-column"
                                >
                                    <i
                                        class="text-5xl fad fa-shirt text-muted"
                                    ></i>
                ...
                <div class="cell large-12">
                            ...
                            <div   v-if="
                            LandingPosts?.['data'] &&
                            LandingPosts?.['data'].length
                        "
                             class="grid-x grid-margin-x grid-padding-y">
                                <div
                                    class="mb-1 cell large-3 medium-6 small-6"
                                    v-for="post in LandingPosts?.['data']"
                                >
                                    <div
                                        class="gap-2 mb-3 card card-body flex-container flex-dir-column"
                                    >
                                        <div class="gap-2 flex-container">
                                            <div class="gap-2 flex-container">
                                                ...
                                                <div>
                                                    ...
                                                    <div
                                                        class="text-sm fw-semibold text-muted"
                                                    >
                                                        By:
                                                        <Link
                                                            :href="
                                        ...
                                        <div
                                            class="gap-4 my-3 mb-1 flex-container align-center flex-dir-column"
                                        >
                                            <div
                                                class="text-sm text-muted fw-semibold text-truncate"
                                            >
                                        ...
                                        <Link
                                            ...
                                            "
                                            class="min-w-0 w-100 text-center btn btn-info btn-sm text-truncate"
                                            >View Post</Link
                                        >
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                >
                                    <i
                                        class="text-5xl fad fa-comment text-muted"
                                    ></i>
                                    <div class="text-lg fw-semibold">
                                        No Posts Created
                                    </div>
