    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Inertia\Ssr\Gateway' => \App\Http\InertiaHttpGateway::class,
    ...
    override(\config(), map([
            ...
            'Values.shop.threed_types' => 'array',
            ...
            'app.admin.domain' => 'string',
            'app.admin.api' => 'string',
            'app.storage.root' => 'string',
            'app.storage.url' => 'string',
            'app.renderer.host' => 'string',
            'app.renderer.port' => 'string',
            'app.renderer.key' => 'string',
            'app.default_avatar_file' => 'string',
            'app.maintenance_password' => 'string',
            'app.ghost_blog_url' => 'string',
            ...
            'filesystems.disks.spaces.url' => 'string',
            'filesystems.disks.spaces.visibility' => 'string',
            'filesystems.disks.spaces.throw' => 'boolean',
            'filesystems.links.C:\laragon\www\melody\public\storage' => 'string',
            ...
            'mail.mailers.mailtrap.transport' => 'string',
            ...
            'scout.meilisearch.index-settings.App\Models\ForumThread.filterableAttributes' => 'array',
            'scout.meilisearch.index-settings.App\Models\ForumThread.sortableAttributes' => 'array',
            ...
            'search_routes.0.name' => 'string',
            'search_routes.0.keywords' => 'array',
            'search_routes.0.url' => 'string',
            'search_routes.0.description' => 'string',
            'search_routes.0.type' => 'string',
            'search_routes.0.icon' => 'string',
            'search_routes.1.name' => 'string',
            'search_routes.1.keywords' => 'array',
            'search_routes.1.url' => 'string',
            'search_routes.1.description' => 'string',
            'search_routes.1.type' => 'string',
            'search_routes.1.icon' => 'string',
            'search_routes.2.name' => 'string',
            'search_routes.2.keywords' => 'array',
            'search_routes.2.url' => 'string',
            'search_routes.2.description' => 'string',
            'search_routes.2.type' => 'string',
            'search_routes.2.icon' => 'string',
            ...
            'varnish.host' => 'array',
            'varnish.administrative_secret' => 'string',
            'varnish.administrative_port' => 'integer',
            'varnish.cache_time_in_minutes' => 'integer',
            'varnish.cacheable_header_name' => 'string',
...
'ActiveLocales.en','ActiveLocales.es','ActiveLocales.ja','ActiveLocales.ru','ActiveLocales.he',
'ItemCategories.Accessories.icon','ItemCategories.Accessories.0.name','ItemCategories.Accessories.0.internal','ItemCategories.Accessories.0.icon','ItemCategories.Accessories.1.name',
'ItemCategories.Accessories.1.internal','ItemCategories.Accessories.1.icon','ItemCategories.Accessories.2.name','ItemCategories.Accessories.2.internal','ItemCategories.Accessories.2.icon',
'ItemCategories.Showpieces.icon','ItemCategories.Showpieces.0.name','ItemCategories.Showpieces.0.internal','ItemCategories.Showpieces.0.icon','ItemCategories.Showpieces.1.name',
'ItemCategories.Showpieces.1.internal','ItemCategories.Showpieces.1.icon','ItemCategories.Showpieces.2.name','ItemCategories.Showpieces.2.internal','ItemCategories.Showpieces.2.icon',
'ItemCategories.Showpieces.3.name','ItemCategories.Showpieces.3.internal','ItemCategories.Showpieces.3.icon','ItemCategories.Showpieces.4.name','ItemCategories.Showpieces.4.internal',
'ItemCategories.Showpieces.4.icon','ItemCategories.Showpieces.5.name','ItemCategories.Showpieces.5.internal','ItemCategories.Showpieces.5.icon','ItemCategories.Clothing.icon',
'ItemCategories.Clothing.0.name','ItemCategories.Clothing.0.internal','ItemCategories.Clothing.0.icon','ItemCategories.Clothing.1.name','ItemCategories.Clothing.1.internal',
'ItemCategories.Clothing.1.icon','ItemCategories.Clothing.2.name','ItemCategories.Clothing.2.internal','ItemCategories.Clothing.2.icon','ItemCategories.Body.icon',
'ItemCategories.Body.0.name','ItemCategories.Body.0.internal','ItemCategories.Body.0.icon','ItemCategories.Body.1.name','ItemCategories.Body.1.internal',
'ItemCategories.Body.1.icon','ItemCategories.Body.2.name','ItemCategories.Body.2.internal','ItemCategories.Body.2.icon','ObtainableItems.admin_item_troll',
'ObtainableItems.starter_item_ids','ObtainableItems.beta_item_ids','PermittedItemTypes.hat','PermittedItemTypes.face','PermittedItemTypes.addon',
'PermittedItemTypes.tool','PermittedItemTypes.tshirt','PermittedItemTypes.shirt','PermittedItemTypes.pants','PermittedItemTypes.head',
'SimpleCategories.0.name','SimpleCategories.0.internal','SimpleCategories.0.icon','SimpleCategories.1.name','SimpleCategories.1.internal',
'SimpleCategories.1.icon','SimpleCategories.2.name','SimpleCategories.2.internal','SimpleCategories.2.icon','SimpleCategories.3.name',
'SimpleCategories.3.internal','SimpleCategories.3.icon','SimpleCategories.4.name','SimpleCategories.4.internal','SimpleCategories.4.icon',
'SimpleCategories.5.name','SimpleCategories.5.internal','SimpleCategories.5.icon','SimpleCategories.6.name','SimpleCategories.6.internal',
'SimpleCategories.6.icon','SimpleCategories.7.name','SimpleCategories.7.internal','SimpleCategories.7.icon','Values.name',
'Values.logo','Values.icon','Values.marketLogo','Values.in_event','Values.system_account_id',
'Values.in_testing_phase','Values.version','Values.frontend.page_loader','Values.frontend.sidebar_menu','Values.frontend.search_bar',
'Values.frontend.loading_messages','Values.price.username','Values.production.domains.main','Values.production.domains.storage','Values.production.domains.api',
'Values.production.domains.careers','Values.production.domains.support','Values.shop.previews_enabled','Values.shop.preview_types','Values.shop.threed_types',
'Values.socials.discord','Values.socials.twitter','Values.socials.twitch','Values.socials.tiktok','Values.socials.facebook',
...
'app.aliases.Vite','app.admin.domain','app.admin.api','app.storage.root','app.storage.url',
'app.renderer.host','app.renderer.port','app.renderer.key','app.default_avatar_file','app.maintenance_password',
'app.ghost_blog_url','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider',
...
'auth.providers.users.model','auth.providers.admin.driver','auth.providers.admin.model','auth.passwords.users.provider','auth.passwords.users.table',
'auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','avatar_colors','broadcasting.default',
...
'broadcasting.connections.pusher.key','broadcasting.connections.pusher.secret','broadcasting.connections.pusher.app_id','broadcasting.connections.pusher.options.host','broadcasting.connections.pusher.options.port',
'broadcasting.connections.pusher.options.scheme','broadcasting.connections.pusher.options.cluster','broadcasting.connections.pusher.options.encrypted','broadcasting.connections.pusher.options.useTLS','broadcasting.connections.pusher.client_options',
...
'cashier.invoices.options.paper','cashier.logger','cors.paths','cors.allowed_methods','cors.allowed_origins',
...
'database.redis.cache.username','database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','discord.client_id',
'discord.client_secret','discord.grant_type','discord.redirect_uri','discord.scopes','discord.prompt',
'discord.error_messages.missing_code','discord.error_messages.invalid_code','discord.error_messages.authorization_failed','discord.error_messages.user_already_linked','discord.error_messages.discord_already_linked',
'discord.error_messages.database_error','discord-alerts.webhook_urls.default','discord-alerts.avatar_urls.default','discord-alerts.job','discord-alerts.queue',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.languages.driver','filesystems.disks.languages.root',
'filesystems.disks.spaces.driver','filesystems.disks.spaces.key','filesystems.disks.spaces.secret','filesystems.disks.spaces.region','filesystems.disks.spaces.bucket',
'filesystems.disks.spaces.endpoint','filesystems.disks.spaces.url','filesystems.disks.spaces.visibility','filesystems.disks.spaces.throw','filesystems.links.C:\\laragon\\www\\melody\\public\\storage',
'filter.blacklist','filter.whitelist_domains','filter.routes','filter.api_urls','hashing.driver',
...
'inertia.history.encrypt','jwt.secret','jwt.keys.public','jwt.keys.private','jwt.keys.passphrase',
...
'level-up.models.achievement','level-up.models.activity','level-up.models.experience','level-up.models.experience_audit','level-up.models.level',
'level-up.models.streak','level-up.models.streak_history','level-up.models.achievement_user','level-up.user.foreign_key','level-up.user.model',
'level-up.user.users_table','level-up.table','level-up.starting_level','level-up.multiplier.enabled','level-up.multiplier.path',
'level-up.multiplier.namespace','level-up.level_cap.enabled','level-up.level_cap.level','level-up.level_cap.points_continue','level-up.audit.enabled',
'level-up.archive_streak_history.enabled','level-up.freeze_duration','localization-js.messages','localization-js.path','logging.default',
...
'mail.mailers.roundrobin.retry_after','mail.mailers.mailtrap.transport','mail.from.address','mail.from.name','mail.markdown.theme',
'mail.markdown.paths','minify.enabled','minify.assets_enabled','minify.assets_route','minify.assets_storage',
'minify.insert_semicolon.css','minify.insert_semicolon.js','minify.remove_comments','minify.obfuscate','minify.ignore',
'minify.enable_directive_replacement','minify.directives.@','minify.keep_directives','octane.server','octane.https',
...
'profanity.replaceFullWords','profanity.replaceWith','profanity.strReplace.a','profanity.strReplace.b','profanity.strReplace.c',
'profanity.strReplace.d','profanity.strReplace.e','profanity.strReplace.f','profanity.strReplace.g','profanity.strReplace.h',
'profanity.strReplace.i','profanity.strReplace.j','profanity.strReplace.k','profanity.strReplace.l','profanity.strReplace.m',
'profanity.strReplace.n','profanity.strReplace.o','profanity.strReplace.p','profanity.strReplace.q','profanity.strReplace.r',
'profanity.strReplace.s','profanity.strReplace.t','profanity.strReplace.u','profanity.strReplace.v','profanity.strReplace.w',
'profanity.strReplace.x','profanity.strReplace.y','profanity.strReplace.z','profanity.defaults','queue.default',
...
'queue.failed.database','queue.failed.table','responsecache.enabled','responsecache.cache_profile','responsecache.cache_bypass_header.name',
'responsecache.cache_bypass_header.value','responsecache.cache_lifetime_in_seconds','responsecache.add_cache_time_header','responsecache.cache_time_header_name','responsecache.add_cache_age_header',
'responsecache.cache_age_header_name','responsecache.cache_store','responsecache.replacers','responsecache.cache_tag','responsecache.hasher',
'responsecache.serializer','reverb.default','reverb.servers.reverb.host','reverb.servers.reverb.port','reverb.servers.reverb.hostname',
...
'reverb.apps.apps.0.allowed_origins','reverb.apps.apps.0.ping_interval','reverb.apps.apps.0.max_message_size','sanctum.stateful','sanctum.guard',
'sanctum.expiration','sanctum.token_prefix','sanctum.middleware.verify_csrf_token','sanctum.middleware.encrypt_cookies','scout.driver',
...
'scout.meilisearch.key','scout.meilisearch.index-settings.App\\Models\\User.filterableAttributes','scout.meilisearch.index-settings.App\\Models\\User.sortableAttributes','scout.meilisearch.index-settings.App\\Models\\Item.filterableAttributes','scout.meilisearch.index-settings.App\\Models\\Item.sortableAttributes',
'scout.meilisearch.index-settings.App\\Models\\Space.filterableAttributes','scout.meilisearch.index-settings.App\\Models\\Space.sortableAttributes','scout.meilisearch.index-settings.App\\Models\\ForumThread.filterableAttributes','scout.meilisearch.index-settings.App\\Models\\ForumThread.sortableAttributes','scout.typesense.client-settings.api_key',
...
'scout.typesense.client-settings.num_retries','scout.typesense.client-settings.retry_interval_seconds','scout.typesense.model-settings','search_routes.0.name','search_routes.0.keywords',
'search_routes.0.url','search_routes.0.description','search_routes.0.type','search_routes.0.icon','search_routes.1.name',
'search_routes.1.keywords','search_routes.1.url','search_routes.1.description','search_routes.1.type','search_routes.1.icon',
'search_routes.2.name','search_routes.2.keywords','search_routes.2.url','search_routes.2.description','search_routes.2.type',
'search_routes.2.icon','services.mailtrap-sdk.host','services.mailtrap-sdk.apiKey','services.mailtrap-sdk.inboxId','services.postmark.token',
...
'services.github.client_id','services.github.client_secret','services.github.redirect','services.discord.client_id','services.discord.client_secret',
'services.discord.redirect','services.discord.allow_gif_avatars','services.discord.avatar_default_extension','services.google.client_id','services.google.client_secret',
'services.google.redirect','services.stripe.key','services.stripe.secret','session.driver','session.lifetime',
...
'session.secure','session.http_only','session.same_site','session.partitioned','swagger-ui.files.0.path',
...
'swagger-ui.files.0.oauth.client_id','swagger-ui.files.0.oauth.client_secret','swagger-ui.files.0.stylesheet','telescope.enabled','telescope.domain',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\GateWatcher.ignore_paths','telescope.watchers.Laravel\\Telescope\\Watchers\\JobWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\LogWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\MailWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ModelWatcher.enabled',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_http_methods','telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_status_codes','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','themes.default',
'themes.roster.light.name','themes.roster.light.lowercase','themes.roster.light.file','themes.roster.light.available','themes.roster.dark.name',
'themes.roster.dark.lowercase','themes.roster.dark.file','themes.roster.dark.available','themes.roster.amoled.name','themes.roster.amoled.lowercase',
'themes.roster.amoled.file','themes.roster.amoled.available','themes.roster.vistora.name','themes.roster.vistora.lowercase','themes.roster.vistora.file',
'themes.roster.vistora.available','themes.roster.discord.name','themes.roster.discord.lowercase','themes.roster.discord.file','themes.roster.discord.available',
'themes.roster.halloween.name','themes.roster.halloween.lowercase','themes.roster.halloween.file','themes.roster.halloween.available','themes.roster.holiday.name',
'themes.roster.holiday.lowercase','themes.roster.holiday.file','themes.roster.holiday.available','themes.roster.classic.name','themes.roster.classic.lowercase',
'themes.roster.classic.file','themes.roster.classic.available','varnish.host','varnish.administrative_secret','varnish.administrative_port',
'varnish.cache_time_in_minutes','varnish.cacheable_header_name','concurrency.default','view.paths','view.compiled',
...
'signed','throttle','verified','admin','cacheable',);
        registerArgumentsSet('routes', 
'debugbar.openhandler','debugbar.clockwork','debugbar.telescope','debugbar.assets.css','debugbar.assets.js',
'debugbar.cache.delete','debugbar.queries.explain','minify.assets','cashier.payment','cashier.webhook',
...
'sanctum.csrf-cookie','swagger.index','swagger.oauth2-redirect','swagger.json','telescope','api.','api.',
'api.messaging.','api.messaging.fetchMessages','api.spaces.','api.search','api.avatar',
'api.user.','api.user.name-availability','api.user.email-validate','api.user.password-validate','api.user.profile-data',
'api.user.online','api.user.inventory','api.user.currently-wearing','api.user.status','api.user.avatar',
'api.user.follow','api.user.unfollow','api.dashboard.','api.dashboard.statuses','api.notif.',
'api.notif.read-all','api.item.rerender','api.store.','api.store.items','api.store.event.items',
'api.store.purchase','api.avatar.','api.avatar.items','api.avatar.wearing-hats','api.avatar.wear-item',
'api.avatar.remove-item','api.settings.','api.settings.uploadBanner','api.settings.bannerVisibility','api.settings.uploadProfilePicture',
'api.settings.changeCountry','api.settings.changePassword','api.rss','api.thumbnails','api.admin.enableMaintenance',
'api.admin.disableMaintenance','api.admin.gift-item','api.admin.purge','maintenance.page',
'maintenance.authenticate.password','maintenance.exit','leaderboard.page','my.money.page','my.money.convert-currency',
'my.dashboard.page','my.dashboard.validate','user.page','user.profile','user.settings.page',
'user.settings.update','user.settings.destroy','promocodes.page','promocodes.redeem','avatar.page',
'avatar.update','forum.','forum.page','forum.your.posts','forum.post',
'forum.create.page','forum.create.validate','forum.reply.validate','chat.messages','chat.validate',
'subscription.checkout','purchase.success','purchase.cancelled','acheivements','notification.page',
...
'auth.register.validate','auth.forgot.page','auth.forgot.password.reset','auth.forgot.password.email','password.confirm.form',
'password.confirm','welcome.page','games.page','games.game','removed',
'store.page','store.create.page','store.create.validate','store.item','store.edit',
'store.edit.validate','store.purchase','membership.page','membership.purchase','search.page',
'develop.page','spaces.page','spaces.create.page','spaces.create.validate','spaces.membership',
'spaces.view','verification.notice','verification.verify','verification.send','admin.page',
'admin.users.page','admin.users.manage-user','admin.users.gift-user','admin.items.page','admin.items.manage-item',
'admin.items.create.create-item','admin.items.create.validate','admin.messaging.page','admin.messaging.validate','admin.reports.page',
'admin.reports.view','admin.assets.approve',);
        registerArgumentsSet('views', 
'app','cashier::invoice','cashier::payment','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','passport::authorize','swagger-ui::index',
'telescope::layout',);
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','en.0','Sidebar.0.url',
'Sidebar.0.active_link','Sidebar.0.section','Sidebar.0.icon','Sidebar.0.title.en','Sidebar.0.title.ru',
'Sidebar.0.title.jp','Sidebar.1.url','Sidebar.1.section','Sidebar.1.active_link','Sidebar.1.icon',
'Sidebar.1.title.en','Sidebar.1.title.ru','Sidebar.1.title.jp','Sidebar.2.url','Sidebar.2.active_link',
'Sidebar.2.icon','Sidebar.2.section','Sidebar.2.title.en','Sidebar.2.title.ru','Sidebar.2.title.jp',
'Sidebar.3.url','Sidebar.3.section','Sidebar.3.active_link','Sidebar.3.icon','Sidebar.3.title.en',
'Sidebar.3.title.ru','Sidebar.3.title.jp','SidebarSections.0.en.name','SidebarSections.0.ru.name','SidebarSections.0.jp.name',
'SidebarSections.1.en.name','SidebarSections.1.ru.name','SidebarSections.1.jp.name','SidebarSections.2.en.name','SidebarSections.2.ru.name',
'SidebarSections.2.jp.name','Dashboard.welcome','Dashboard.feed','validation.password','profanity.0',
'laravel-profane::validation.profane','profanity::profanity.0','profanity::profanity.1','profanity::profanity.2','profanity::profanity.3',
'profanity::profanity.4','profanity::profanity.5','profanity::profanity.6','profanity::profanity.7','profanity::profanity.8',
'profanity::profanity.9','profanity::profanity.10','profanity::profanity.11','profanity::profanity.12','profanity::profanity.13',
'profanity::profanity.14','profanity::profanity.15','profanity::profanity.16','profanity::profanity.17','profanity::profanity.18',
'profanity::profanity.19','profanity::profanity.20','profanity::profanity.21','profanity::profanity.22','profanity::profanity.23',
'profanity::profanity.24','profanity::profanity.25','profanity::profanity.26','profanity::profanity.27','profanity::profanity.28',
'profanity::profanity.29','profanity::profanity.30','profanity::profanity.31','profanity::profanity.32','profanity::profanity.33',
'profanity::profanity.34','profanity::profanity.35','profanity::profanity.36','profanity::profanity.37','profanity::profanity.38',
'profanity::profanity.39','profanity::profanity.40','profanity::profanity.41','profanity::profanity.42','profanity::profanity.43',
'profanity::profanity.44','profanity::profanity.45','profanity::profanity.46','profanity::profanity.47','profanity::profanity.48',
'profanity::profanity.49','profanity::profanity.50','profanity::profanity.51','profanity::profanity.52','profanity::profanity.53',
'profanity::profanity.54','profanity::profanity.55','profanity::profanity.56','profanity::profanity.57','profanity::profanity.58',
'profanity::profanity.59','profanity::profanity.60','profanity::profanity.61','profanity::profanity.62','profanity::profanity.63',
'profanity::profanity.64','profanity::profanity.65','profanity::profanity.66','profanity::profanity.67',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_TIMEZONE','APP_SERVICE','APP_PORT','APP_LOCALE','APP_FALLBACK_LOCALE',
...
'DB_USERNAME','DB_PASSWORD','DB_VOLUME_LOCAL','DB_VOLUME_TEST','CACHE_STORE',
...
'DO_URL','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URL','PUSHER_APP_ID',
'PUSHER_APP_KEY','PUSHER_APP_SECRET','PUSHER_HOST','PUSHER_PORT','PUSHER_SCHEME',
'PUSHER_APP_CLUSTER','DEBUGBAR_OPEN_STORAGE','VITE_APP_NAME','VITE_PUSHER_APP_KEY','VITE_PUSHER_HOST',
'VITE_PUSHER_PORT','VITE_PUSHER_SCHEME','VITE_PUSHER_APP_CLUSTER','REVERB_APP_ID','REVERB_APP_KEY',
'REVERB_APP_SECRET','REVERB_HOST','REVERB_PORT','REVERB_SCHEME','NOVU_API_KEY',
'VITE_REVERB_APP_KEY','VITE_REVERB_HOST','VITE_REVERB_PORT','VITE_REVERB_SCHEME','OCTANE_SERVER',
'OCTANE_HTTPS','SCOUT_DRIVER','MEILISEARCH_HOST','MEILISEARCH_KEY','MEILISEARCH_NO_ANALYTICS',
'MEILISEARCH_NO_SENTRY','WORKDIR','MYSQL_VERSION','REDIS_VERSION','FORWARD_MINIO_PORT',
'FORWARD_MINIO_CONSOLE_PORT','MINIO_ROOT_USER','MINIO_ROOT_PASSWORD','MINIO_VOLUME_LOCAL','FORWARD_MAILPIT_PORT',
'FORWARD_MAILPIT_DASHBOARD_PORT','SAIL_XDEBUG_MODE','FORWARD_DB_PORT','FORWARD_REDIS_PORT','STRIPE_KEY',
'STRIPE_SECRET','CASHIER_LOGGER','DEBUGBAR_ENABLED',);
