...
'ActiveLocales.es','ActiveLocales.ja','ActiveLocales.ru','ActiveLocales.he','ItemCategories.Accessories.icon',
'ItemCategories.Accessories.0.name','ItemCategories.Accessories.0.internal','ItemCategories.Accessories.0.icon','ItemCategories.Accessories.1.name','ItemCategories.Accessories.1.internal',
'ItemCategories.Accessories.1.icon','ItemCategories.Accessories.2.name','ItemCategories.Accessories.2.internal','ItemCategories.Accessories.2.icon','ItemCategories.Showpieces.icon',
'ItemCategories.Showpieces.0.name','ItemCategories.Showpieces.0.internal','ItemCategories.Showpieces.0.icon','ItemCategories.Showpieces.1.name','ItemCategories.Showpieces.1.internal',
'ItemCategories.Showpieces.1.icon','ItemCategories.Showpieces.2.name','ItemCategories.Showpieces.2.internal','ItemCategories.Showpieces.2.icon','ItemCategories.Showpieces.3.name',
'ItemCategories.Showpieces.3.internal','ItemCategories.Showpieces.3.icon','ItemCategories.Showpieces.4.name','ItemCategories.Showpieces.4.internal','ItemCategories.Showpieces.4.icon',
'ItemCategories.Showpieces.5.name','ItemCategories.Showpieces.5.internal','ItemCategories.Showpieces.5.icon','ItemCategories.Clothing.icon','ItemCategories.Clothing.0.name',
'ItemCategories.Clothing.0.internal','ItemCategories.Clothing.0.icon','ItemCategories.Clothing.1.name','ItemCategories.Clothing.1.internal','ItemCategories.Clothing.1.icon',
'ItemCategories.Clothing.2.name','ItemCategories.Clothing.2.internal','ItemCategories.Clothing.2.icon','ItemCategories.Body.icon','ItemCategories.Body.0.name',
'ItemCategories.Body.0.internal','ItemCategories.Body.0.icon','ItemCategories.Body.1.name','ItemCategories.Body.1.internal','ItemCategories.Body.1.icon',
'ItemCategories.Body.2.name','ItemCategories.Body.2.internal','ItemCategories.Body.2.icon','ObtainableItems.admin_item_troll','ObtainableItems.starter_item_ids',
'ObtainableItems.beta_item_ids','PermittedItemTypes.hat','PermittedItemTypes.face','PermittedItemTypes.addon','PermittedItemTypes.tool',
'PermittedItemTypes.tshirt','PermittedItemTypes.shirt','PermittedItemTypes.pants','PermittedItemTypes.head','SimpleCategories.0.name',
'SimpleCategories.0.internal','SimpleCategories.0.icon','SimpleCategories.1.name','SimpleCategories.1.internal','SimpleCategories.1.icon',
'SimpleCategories.2.name','SimpleCategories.2.internal','SimpleCategories.2.icon','SimpleCategories.3.name','SimpleCategories.3.internal',
'SimpleCategories.3.icon','SimpleCategories.4.name','SimpleCategories.4.internal','SimpleCategories.4.icon','SimpleCategories.5.name',
'SimpleCategories.5.internal','SimpleCategories.5.icon','SimpleCategories.6.name','SimpleCategories.6.internal','SimpleCategories.6.icon',
'SimpleCategories.7.name','SimpleCategories.7.internal','SimpleCategories.7.icon','Values.name','Values.logo',
'Values.icon','Values.marketLogo','Values.in_event','Values.system_account_id','Values.in_testing_phase',
'Values.version','Values.frontend.page_loader','Values.frontend.sidebar_menu','Values.frontend.search_bar','Values.frontend.loading_messages',
'Values.price.username','Values.production.domains.main','Values.production.domains.storage','Values.production.domains.api','Values.production.domains.careers',
'Values.production.domains.support','Values.shop.previews_enabled','Values.shop.preview_types','Values.socials.discord','Values.socials.twitter',
'Values.socials.twitch','Values.socials.tiktok','Values.socials.facebook','app.name','app.env',
...
'database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','discord.client_id','discord.client_secret',
'discord.grant_type','discord.redirect_uri','discord.scopes','discord.prompt','discord.error_messages.missing_code',
'discord.error_messages.invalid_code','discord.error_messages.authorization_failed','discord.error_messages.user_already_linked','discord.error_messages.discord_already_linked','discord.error_messages.database_error',
'discord-alerts.webhook_urls.default','discord-alerts.avatar_urls.default','discord-alerts.job','filesystems.default','filesystems.disks.local.driver',
...
'filesystems.disks.s3.throw','filesystems.disks.languages.driver','filesystems.disks.languages.root','filesystems.disks.spaces.driver','filesystems.disks.spaces.key',
'filesystems.disks.spaces.secret','filesystems.disks.spaces.region','filesystems.disks.spaces.bucket','filesystems.disks.spaces.endpoint','filesystems.disks.spaces.url',
'filesystems.disks.spaces.visibility','filesystems.disks.spaces.throw','filesystems.links./var/www/melody/public/storage','filter.blacklist','filter.whitelist_domains',
'filter.routes','filter.api_urls','hashing.driver','hashing.bcrypt.rounds','hashing.argon.memory',
'hashing.argon.threads','hashing.argon.time','hashing.rehash_on_login','inertia.ssr.enabled','inertia.ssr.url',
'inertia.testing.ensure_pages_exist','inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','jwt.secret',
...
'jwt.blacklist_enabled','jwt.blacklist_grace_period','jwt.show_black_list_exception','jwt.decrypt_cookies','jwt.cookie_key_name',
'jwt.providers.jwt','jwt.providers.auth','jwt.providers.storage','level-up.models.achievement','level-up.models.activity',
'level-up.models.experience','level-up.models.experience_audit','level-up.models.level','level-up.models.streak','level-up.models.streak_history',
'level-up.models.achievement_user','level-up.user.foreign_key','level-up.user.model','level-up.user.users_table','level-up.table',
'level-up.starting_level','level-up.multiplier.enabled','level-up.multiplier.path','level-up.multiplier.namespace','level-up.level_cap.enabled',
'level-up.level_cap.level','level-up.level_cap.points_continue','level-up.audit.enabled','level-up.archive_streak_history.enabled','level-up.freeze_duration',
'localization-js.messages','localization-js.path','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'json-api-paginate.pagination_parameter','location.driver','location.fallbacks','location.position','location.http.timeout',
'location.http.connect_timeout','location.testing.ip','location.testing.enabled','location.maxmind.license_key','location.maxmind.web.enabled',
'location.maxmind.web.user_id','location.maxmind.web.options.host','location.maxmind.local.type','location.maxmind.local.path','location.maxmind.local.url',
...
'leaderboard.page','my.money.page','my.money.convert-currency','my.dashboard.page','my.dashboard.validate',
...
'auth.register.page','auth.register.validate','auth.forgot.page','auth.forgot.password.reset','auth.forgot.password.email','password.confirm.form','password.confirm','Welcome',
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','Sidebar.0.url','Sidebar.0.active_link',
'Sidebar.0.section','Sidebar.0.icon','Sidebar.0.title.en','Sidebar.0.title.ru','Sidebar.0.title.jp',
'Sidebar.1.url','Sidebar.1.section','Sidebar.1.active_link','Sidebar.1.icon','Sidebar.1.title.en',
'Sidebar.1.title.ru','Sidebar.1.title.jp','Sidebar.2.url','Sidebar.2.active_link','Sidebar.2.icon',
'Sidebar.2.section','Sidebar.2.title.en','Sidebar.2.title.ru','Sidebar.2.title.jp','Sidebar.3.url',
'Sidebar.3.section','Sidebar.3.active_link','Sidebar.3.icon','Sidebar.3.title.en','Sidebar.3.title.ru',
'Sidebar.3.title.jp','SidebarSections.0.en.name','SidebarSections.0.ru.name','SidebarSections.0.jp.name','SidebarSections.1.en.name',
'SidebarSections.1.ru.name','SidebarSections.1.jp.name','SidebarSections.2.en.name','SidebarSections.2.ru.name','SidebarSections.2.jp.name',
'Dashboard.welcome','Dashboard.feed','validation.password','profanity.0','laravel-profane::validation.profane',
'profanity::profanity.0','profanity::profanity.1','profanity::profanity.2','profanity::profanity.3','profanity::profanity.4',
'profanity::profanity.5','profanity::profanity.6','profanity::profanity.7','profanity::profanity.8','profanity::profanity.9',
'profanity::profanity.10','profanity::profanity.11','profanity::profanity.12','profanity::profanity.13','profanity::profanity.14',
'profanity::profanity.15','profanity::profanity.16','profanity::profanity.17','profanity::profanity.18','profanity::profanity.19',
'profanity::profanity.20','profanity::profanity.21','profanity::profanity.22','profanity::profanity.23','profanity::profanity.24',
'profanity::profanity.25','profanity::profanity.26','profanity::profanity.27','profanity::profanity.28','profanity::profanity.29',
'profanity::profanity.30','profanity::profanity.31','profanity::profanity.32','profanity::profanity.33','profanity::profanity.34',
'profanity::profanity.35','profanity::profanity.36','profanity::profanity.37','profanity::profanity.38','profanity::profanity.39',
'profanity::profanity.40','profanity::profanity.41','profanity::profanity.42','profanity::profanity.43','profanity::profanity.44',
'profanity::profanity.45','profanity::profanity.46','profanity::profanity.47','profanity::profanity.48','profanity::profanity.49',
'profanity::profanity.50','profanity::profanity.51','profanity::profanity.52','profanity::profanity.53','profanity::profanity.54',
'profanity::profanity.55','profanity::profanity.56','profanity::profanity.57','profanity::profanity.58','profanity::profanity.59',
'profanity::profanity.60','profanity::profanity.61','profanity::profanity.62','profanity::profanity.63','profanity::profanity.64',
'profanity::profanity.65','profanity::profanity.66','profanity::profanity.67',);
