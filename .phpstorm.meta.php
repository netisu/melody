...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'Values.minimum_age_without_consent' => 'integer',
            ...
            'services.mailtrap-sdk.apiKey' => 'string',
...
'Values.logo','Values.icon','Values.marketLogo','Values.minimum_age_without_consent','Values.in_event',
'Values.system_account_id','Values.in_testing_phase','Values.version','Values.frontend.page_loader','Values.frontend.sidebar_menu',
'Values.frontend.search_bar','Values.frontend.loading_messages','Values.price.username','Values.production.domains.main','Values.production.domains.storage',
'Values.production.domains.api','Values.production.domains.careers','Values.production.domains.support','Values.shop.previews_enabled','Values.shop.preview_types',
'Values.shop.threed_types','Values.socials.discord','Values.socials.twitter','Values.socials.twitch','Values.socials.tiktok',
'Values.socials.facebook','app.name','app.env','app.debug','app.url',
...
'app.aliases.View','app.aliases.Vite','app.admin.domain','app.admin.api','app.storage.root',
'app.storage.url','app.renderer.host','app.renderer.port','app.renderer.key','app.default_avatar_file',
'app.maintenance_password','app.ghost_blog_url','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'auth.providers.users.driver','auth.providers.users.model','auth.providers.admin.driver','auth.providers.admin.model','auth.passwords.users.provider',
'auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','avatar_colors',
...
'broadcasting.connections.pusher.options.port','broadcasting.connections.pusher.options.scheme','broadcasting.connections.pusher.options.cluster','broadcasting.connections.pusher.options.encrypted','broadcasting.connections.pusher.options.useTLS',
...
'cashier.invoices.renderer','cashier.invoices.options.paper','cashier.logger','cors.paths','cors.allowed_methods',
...
'database.connections.mongodb.dsn','database.connections.mongodb.database','database.migrations.table','database.migrations.update_date_on_publish','database.redis.client',
...
'mail.mailers.failover.retry_after','mail.mailers.roundrobin.transport','mail.mailers.roundrobin.mailers','mail.mailers.roundrobin.retry_after','mail.mailers.mailtrap-sdk.transport',
...
'minify.keep_directives','octane.server','octane.https','octane.listeners.Laravel\\Octane\\Events\\WorkerStarting','octane.listeners.Laravel\\Octane\\Events\\RequestReceived',
...
'octane.watch','octane.garbage','octane.max_execution_time','profanity.replaceFullWords','profanity.replaceWith',
'profanity.strReplace.a','profanity.strReplace.b','profanity.strReplace.c','profanity.strReplace.d','profanity.strReplace.e',
'profanity.strReplace.f','profanity.strReplace.g','profanity.strReplace.h','profanity.strReplace.i','profanity.strReplace.j',
'profanity.strReplace.k','profanity.strReplace.l','profanity.strReplace.m','profanity.strReplace.n','profanity.strReplace.o',
'profanity.strReplace.p','profanity.strReplace.q','profanity.strReplace.r','profanity.strReplace.s','profanity.strReplace.t',
'profanity.strReplace.u','profanity.strReplace.v','profanity.strReplace.w','profanity.strReplace.x','profanity.strReplace.y',
'profanity.strReplace.z','profanity.defaults','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'responsecache.replacers','responsecache.cache_tag','responsecache.hasher','responsecache.serializer','reverb.default',
...
'sanctum.middleware.verify_csrf_token','sanctum.middleware.encrypt_cookies','scout.driver','scout.prefix','scout.queue',
'scout.after_commit','scout.chunk.searchable','scout.chunk.unsearchable','scout.soft_delete','scout.identify',
'scout.algolia.id','scout.algolia.secret','scout.meilisearch.host','scout.meilisearch.key','scout.meilisearch.index-settings.App\\Models\\User.filterableAttributes',
'scout.meilisearch.index-settings.App\\Models\\User.sortableAttributes','scout.meilisearch.index-settings.App\\Models\\Item.filterableAttributes','scout.meilisearch.index-settings.App\\Models\\Item.sortableAttributes','scout.meilisearch.index-settings.App\\Models\\Space.filterableAttributes','scout.meilisearch.index-settings.App\\Models\\Space.sortableAttributes',
'scout.meilisearch.index-settings.App\\Models\\ForumThread.filterableAttributes','scout.meilisearch.index-settings.App\\Models\\ForumThread.sortableAttributes','scout.typesense.client-settings.api_key','scout.typesense.client-settings.nodes.0.host','scout.typesense.client-settings.nodes.0.port',
...
'scout.typesense.model-settings','search_routes.0.name','search_routes.0.keywords','search_routes.0.url','search_routes.0.description',
'search_routes.0.type','search_routes.0.icon','search_routes.1.name','search_routes.1.keywords','search_routes.1.url',
'search_routes.1.description','search_routes.1.type','search_routes.1.icon','search_routes.2.name','search_routes.2.keywords',
'search_routes.2.url','search_routes.2.description','search_routes.2.type','search_routes.2.icon','services.mailtrap-sdk.host',
'services.mailtrap-sdk.apiKey','services.mailtrap-sdk.inboxId','services.postmark.token','services.resend.key','services.ses.key',
...
'services.mailgun.secret','services.mailgun.endpoint','services.mailgun.scheme','services.github.client_id','services.github.client_secret',
'services.github.redirect','services.discord.client_id','services.discord.client_secret','services.discord.redirect','services.discord.allow_gif_avatars',
'services.discord.avatar_default_extension','services.google.client_id','services.google.client_secret','services.google.redirect','services.stripe.key',
...
'session.same_site','session.partitioned','swagger-ui.files.0.path','swagger-ui.files.0.title','swagger-ui.files.0.versions.v1',
...
'swagger-ui.files.0.stylesheet','telescope.enabled','telescope.domain','telescope.path','telescope.driver',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','themes.default','themes.roster.light.name','themes.roster.light.lowercase',
'themes.roster.light.file','themes.roster.light.available','themes.roster.dark.name','themes.roster.dark.lowercase','themes.roster.dark.file',
'themes.roster.dark.available','themes.roster.amoled.name','themes.roster.amoled.lowercase','themes.roster.amoled.file','themes.roster.amoled.available',
'themes.roster.vistora.name','themes.roster.vistora.lowercase','themes.roster.vistora.file','themes.roster.vistora.available','themes.roster.discord.name',
'themes.roster.discord.lowercase','themes.roster.discord.file','themes.roster.discord.available','themes.roster.halloween.name','themes.roster.halloween.lowercase',
'themes.roster.halloween.file','themes.roster.halloween.available','themes.roster.holiday.name','themes.roster.holiday.lowercase','themes.roster.holiday.file',
'themes.roster.holiday.available','themes.roster.classic.name','themes.roster.classic.lowercase','themes.roster.classic.file','themes.roster.classic.available',
'varnish.host','varnish.administrative_secret','varnish.administrative_port','varnish.cache_time_in_minutes','varnish.cacheable_header_name',
...
'passport.personal_access_client.id','passport.personal_access_client.secret','purifier.encoding','purifier.finalize','purifier.ignoreNonStrings',
...
'purifier.settings.custom_definition.id','purifier.settings.custom_definition.rev','purifier.settings.custom_definition.debug','purifier.settings.custom_definition.elements.0','purifier.settings.custom_definition.elements.1',
'purifier.settings.custom_definition.elements.2','purifier.settings.custom_definition.elements.3','purifier.settings.custom_definition.elements.4','purifier.settings.custom_definition.elements.5','purifier.settings.custom_definition.elements.6',
'purifier.settings.custom_definition.elements.7','purifier.settings.custom_definition.elements.8','purifier.settings.custom_definition.elements.9','purifier.settings.custom_definition.elements.10','purifier.settings.custom_definition.elements.10.4.src',
...
'purifier.settings.custom_definition.elements.10.4.controls','purifier.settings.custom_definition.elements.11','purifier.settings.custom_definition.elements.11.4.src','purifier.settings.custom_definition.elements.11.4.type','purifier.settings.custom_definition.elements.12',
'purifier.settings.custom_definition.elements.13','purifier.settings.custom_definition.elements.14','purifier.settings.custom_definition.elements.15','purifier.settings.custom_definition.elements.16','purifier.settings.custom_definition.elements.17',
'purifier.settings.custom_definition.elements.18','purifier.settings.custom_definition.elements.18.4.cite','purifier.settings.custom_definition.elements.18.4.datetime','purifier.settings.custom_definition.elements.19','purifier.settings.custom_definition.elements.19.4.cite',
'purifier.settings.custom_definition.elements.19.4.datetime','purifier.settings.custom_definition.attributes.0','purifier.settings.custom_definition.attributes.1','purifier.settings.custom_definition.attributes.2','purifier.settings.custom_definition.attributes.3',
'purifier.settings.custom_definition.attributes.4','purifier.settings.custom_definition.attributes.5','purifier.settings.custom_definition.attributes.6','purifier.settings.custom_attributes.0','purifier.settings.custom_elements.0',
'laravelcloudflare.enabled','laravelcloudflare.replace_ip','laravelcloudflare.cache','laravelcloudflare.url','laravelcloudflare.ipv4-path',
'laravelcloudflare.ipv6-path','json-api-paginate.max_results','json-api-paginate.default_size','json-api-paginate.number_parameter','json-api-paginate.size_parameter',
'json-api-paginate.cursor_parameter','json-api-paginate.method_name','json-api-paginate.use_simple_pagination','json-api-paginate.use_cursor_pagination','json-api-paginate.use_fast_pagination',
'json-api-paginate.base_url','json-api-paginate.pagination_parameter','location.driver','location.fallbacks','location.position',
...
'location.maxmind.web.enabled','location.maxmind.web.user_id','location.maxmind.web.options.host','location.maxmind.local.type','location.maxmind.local.path',
'location.maxmind.local.url','location.ip_api.token','location.ipinfo.token','location.ipdata.token','location.ip2locationio.token',
'location.kloudend.token','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'api.user.','api.user.name-availability','api.user.email-validate','api.user.profile-image','api.user.password-validate',
'api.user.profile-data','api.user.online','api.user.inventory','api.user.currently-wearing','api.user.status',
'api.user.avatar','api.user.follow','api.user.unfollow','api.dashboard.','api.dashboard.statuses',
'api.notif.','api.notif.read-all','api.item.rerender','api.store.','api.store.items',
'api.store.event.items','api.store.purchase','api.avatar.','api.avatar.items','api.avatar.wearing-hats',
'api.avatar.wear-item','api.avatar.remove-item','api.settings.','api.settings.uploadBanner','api.settings.bannerVisibility',
...
'my.money.convert-currency','my.dashboard.page','my.dashboard.validate','user.page','user.profile',
'user.inventory','user.settings.page','user.settings.update','user.settings.destroy','promocodes.page',
'promocodes.redeem','avatar.page','avatar.update','forum.','forum.page',
'forum.your.posts','forum.post','forum.create.page','forum.create.validate','forum.reply.validate',
'chat.messages','chat.validate','subscription.checkout','purchase.success','purchase.cancelled',
'acheivements','notification.page','notification.view','auth.logout','auth.providers',
'auth.language','auth.login.google.auth','auth.login.google.validation','auth.login.discord.auth','auth.login.discord.validation',
...
'spaces.view','verification.notice','verification.verify','verification.send','policies.tos',
'policies.privacy','admin.page','admin.users.page','admin.users.manage-user','admin.users.gift-user',
'admin.items.page','admin.items.manage-item','admin.items.create.create-item','admin.items.create.validate','admin.messaging.page',
'admin.messaging.validate','admin.reports.page','admin.reports.view','admin.assets.approve',);
...
'Sidebar.0.url','Sidebar.0.active_link','Sidebar.0.section','Sidebar.0.icon','Sidebar.0.title.en',
'Sidebar.0.title.ru','Sidebar.0.title.jp','Sidebar.1.url','Sidebar.1.section','Sidebar.1.active_link',
'Sidebar.1.icon','Sidebar.1.title.en','Sidebar.1.title.ru','Sidebar.1.title.jp','Sidebar.2.url',
'Sidebar.2.active_link','Sidebar.2.icon','Sidebar.2.section','Sidebar.2.title.en','Sidebar.2.title.ru',
'Sidebar.2.title.jp','Sidebar.3.url','Sidebar.3.section','Sidebar.3.active_link','Sidebar.3.icon',
'Sidebar.3.title.en','Sidebar.3.title.ru','Sidebar.3.title.jp','SidebarSections.0.en.name','SidebarSections.0.ru.name',
'SidebarSections.0.jp.name','SidebarSections.1.en.name','SidebarSections.1.ru.name','SidebarSections.1.jp.name','SidebarSections.2.en.name',
'SidebarSections.2.ru.name','SidebarSections.2.jp.name','Dashboard.welcome','Dashboard.feed','validation.password',
'profanity.0','laravel-profane::validation.profane','profanity::profanity.0','profanity::profanity.1','profanity::profanity.2',
'profanity::profanity.3','profanity::profanity.4','profanity::profanity.5','profanity::profanity.6','profanity::profanity.7',
'profanity::profanity.8','profanity::profanity.9','profanity::profanity.10','profanity::profanity.11','profanity::profanity.12',
'profanity::profanity.13','profanity::profanity.14','profanity::profanity.15','profanity::profanity.16','profanity::profanity.17',
'profanity::profanity.18','profanity::profanity.19','profanity::profanity.20','profanity::profanity.21','profanity::profanity.22',
'profanity::profanity.23','profanity::profanity.24','profanity::profanity.25','profanity::profanity.26','profanity::profanity.27',
'profanity::profanity.28','profanity::profanity.29','profanity::profanity.30','profanity::profanity.31','profanity::profanity.32',
'profanity::profanity.33','profanity::profanity.34','profanity::profanity.35','profanity::profanity.36','profanity::profanity.37',
'profanity::profanity.38','profanity::profanity.39','profanity::profanity.40','profanity::profanity.41','profanity::profanity.42',
'profanity::profanity.43','profanity::profanity.44','profanity::profanity.45','profanity::profanity.46','profanity::profanity.47',
'profanity::profanity.48','profanity::profanity.49','profanity::profanity.50','profanity::profanity.51','profanity::profanity.52',
'profanity::profanity.53','profanity::profanity.54','profanity::profanity.55','profanity::profanity.56','profanity::profanity.57',
'profanity::profanity.58','profanity::profanity.59','profanity::profanity.60','profanity::profanity.61','profanity::profanity.62',
'profanity::profanity.63','profanity::profanity.64','profanity::profanity.65','profanity::profanity.66','profanity::profanity.67',);
...
'REDIS_VOLUME_LOCAL','MP_VOLUME_LOCAL','MAIL_MAILER','MAILTRAP_HOST','MAILTRAP_API_KEY',
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY',
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','DO_SPACES_KEY','DO_SPACES_SECRET',
'DO_SPACES_REGION','DO_SPACES_BUCKET','DO_SPACES_ENDPOINT','DO_URL','GOOGLE_CLIENT_ID',
'GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URL','PUSHER_APP_ID','PUSHER_APP_KEY','PUSHER_APP_SECRET',
'PUSHER_HOST','PUSHER_PORT','PUSHER_SCHEME','PUSHER_APP_CLUSTER','DEBUGBAR_OPEN_STORAGE',
'VITE_APP_NAME','VITE_PUSHER_APP_KEY','VITE_PUSHER_HOST','VITE_PUSHER_PORT','VITE_PUSHER_SCHEME',
'VITE_PUSHER_APP_CLUSTER','REVERB_APP_ID','REVERB_APP_KEY','REVERB_APP_SECRET','REVERB_HOST',
'REVERB_PORT','REVERB_SCHEME','NOVU_API_KEY','VITE_REVERB_APP_KEY','VITE_REVERB_HOST',
'VITE_REVERB_PORT','VITE_REVERB_SCHEME','OCTANE_SERVER','OCTANE_HTTPS','SCOUT_DRIVER',
'MEILISEARCH_HOST','MEILISEARCH_KEY','MEILISEARCH_NO_ANALYTICS','MEILISEARCH_NO_SENTRY','WORKDIR',
'MYSQL_VERSION','REDIS_VERSION','FORWARD_MINIO_PORT','FORWARD_MINIO_CONSOLE_PORT','MINIO_ROOT_USER',
'MINIO_ROOT_PASSWORD','MINIO_VOLUME_LOCAL','FORWARD_MAILPIT_PORT','FORWARD_MAILPIT_DASHBOARD_PORT','SAIL_XDEBUG_MODE',
'FORWARD_DB_PORT','FORWARD_REDIS_PORT','STRIPE_KEY','STRIPE_SECRET','CASHIER_LOGGER',
'DEBUGBAR_ENABLED',);
