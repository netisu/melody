...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'search_routes.3.name' => 'string',
            'search_routes.3.keywords' => 'array',
            'search_routes.3.url' => 'string',
            'search_routes.3.description' => 'string',
            'search_routes.3.type' => 'string',
            'search_routes.3.icon' => 'string',
...
'auth.guards.admin.driver','auth.guards.admin.provider','auth.guards.api.driver','auth.guards.api.provider','auth.guards.sanctum.driver',
'auth.guards.sanctum.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers.admin.driver','auth.providers.admin.model',
...
'avatar_colors','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key','broadcasting.connections.reverb.secret',
...
'broadcasting.connections.pusher.options.host','broadcasting.connections.pusher.options.port','broadcasting.connections.pusher.options.scheme','broadcasting.connections.pusher.options.cluster','broadcasting.connections.pusher.options.encrypted',
...
'cache.stores.octane.driver','cache.prefix','cashier.key','cashier.secret','cashier.path',
'cashier.webhook.secret','cashier.webhook.tolerance','cashier.webhook.events','cashier.currency','cashier.currency_locale',
'cashier.payment_notification','cashier.invoices.renderer','cashier.invoices.options.paper','cashier.logger','cors.paths',
...
'database.connections.mongodb.driver','database.connections.mongodb.dsn','database.connections.mongodb.database','database.migrations.table','database.migrations.update_date_on_publish',
...
'discord.client_id','discord.client_secret','discord.grant_type','discord.redirect_uri','discord.scopes',
'discord.prompt','discord.error_messages.missing_code','discord.error_messages.invalid_code','discord.error_messages.authorization_failed','discord.error_messages.user_already_linked',
'discord.error_messages.discord_already_linked','discord.error_messages.database_error','discord-alerts.webhook_urls.default','discord-alerts.avatar_urls.default','discord-alerts.job',
'discord-alerts.queue','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.throw',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.languages.driver',
'filesystems.disks.languages.root','filesystems.disks.spaces.driver','filesystems.disks.spaces.key','filesystems.disks.spaces.secret','filesystems.disks.spaces.region',
'filesystems.disks.spaces.bucket','filesystems.disks.spaces.endpoint','filesystems.disks.spaces.url','filesystems.disks.spaces.visibility','filesystems.disks.spaces.throw',
'filesystems.links.C:\\laragon\\www\\melody\\public\\storage','filter.blacklist','filter.whitelist_domains','filter.routes','filter.api_urls',
...
'inertia.testing.page_extensions','inertia.history.encrypt','jwt.secret','jwt.keys.public','jwt.keys.private',
...
'jwt.providers.storage','level-up.models.achievement','level-up.models.activity','level-up.models.experience','level-up.models.experience_audit',
'level-up.models.level','level-up.models.streak','level-up.models.streak_history','level-up.models.achievement_user','level-up.user.foreign_key',
'level-up.user.model','level-up.user.users_table','level-up.table','level-up.starting_level','level-up.multiplier.enabled',
'level-up.multiplier.path','level-up.multiplier.namespace','level-up.level_cap.enabled','level-up.level_cap.level','level-up.level_cap.points_continue',
'level-up.audit.enabled','level-up.archive_streak_history.enabled','level-up.freeze_duration','localization-js.messages','localization-js.path',
...
'minify.enabled','minify.assets_enabled','minify.assets_route','minify.assets_storage','minify.insert_semicolon.css',
'minify.insert_semicolon.js','minify.remove_comments','minify.obfuscate','minify.ignore','minify.enable_directive_replacement',
'minify.directives.@','minify.keep_directives','octane.server','octane.https','octane.listeners.Laravel\\Octane\\Events\\WorkerStarting',
...
'octane.cache.bytes','octane.watch','octane.garbage','octane.max_execution_time','profanity.replaceFullWords',
...
'queue.failed.table','responsecache.enabled','responsecache.cache_profile','responsecache.cache_bypass_header.name','responsecache.cache_bypass_header.value',
'responsecache.cache_lifetime_in_seconds','responsecache.add_cache_time_header','responsecache.cache_time_header_name','responsecache.add_cache_age_header','responsecache.cache_age_header_name',
'responsecache.cache_store','responsecache.replacers','responsecache.cache_tag','responsecache.hasher','responsecache.serializer',
...
'reverb.apps.apps.0.ping_interval','reverb.apps.apps.0.max_message_size','sanctum.stateful','sanctum.guard','sanctum.expiration',
'sanctum.token_prefix','sanctum.middleware.verify_csrf_token','sanctum.middleware.encrypt_cookies','scout.driver','scout.prefix',
...
'scout.meilisearch.index-settings.App\\Models\\User.filterableAttributes','scout.meilisearch.index-settings.App\\Models\\User.sortableAttributes','scout.meilisearch.index-settings.App\\Models\\Item.filterableAttributes','scout.meilisearch.index-settings.App\\Models\\Item.sortableAttributes','scout.meilisearch.index-settings.App\\Models\\Space.filterableAttributes',
'scout.meilisearch.index-settings.App\\Models\\Space.sortableAttributes','scout.typesense.client-settings.api_key','scout.typesense.client-settings.nodes.0.host','scout.typesense.client-settings.nodes.0.port','scout.typesense.client-settings.nodes.0.path',
...
'search_routes.0.name','search_routes.0.keywords','search_routes.0.url','search_routes.0.description','search_routes.0.type',
'search_routes.0.icon','search_routes.1.name','search_routes.1.keywords','search_routes.1.url','search_routes.1.description',
'search_routes.1.type','search_routes.1.icon','search_routes.2.name','search_routes.2.keywords','search_routes.2.url',
'search_routes.2.description','search_routes.2.type','search_routes.2.icon','search_routes.3.name','search_routes.3.keywords',
'search_routes.3.url','search_routes.3.description','search_routes.3.type','search_routes.3.icon','services.postmark.token',
