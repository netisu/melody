...
'mail.mailers.smtp.transport','mail.mailers.smtp.url','mail.mailers.smtp.host','mail.mailers.smtp.port','mail.mailers.smtp.username',
...
'mail.mailers.roundrobin.mailers','mail.mailers.roundrobin.retry_after','mail.mailers.mailtrap-sdk.transport','mail.from.address','mail.from.name',
'mail.markdown.theme','mail.markdown.paths','minify.enabled','minify.assets_enabled','minify.assets_route',
'minify.assets_storage','minify.insert_semicolon.css','minify.insert_semicolon.js','minify.remove_comments','minify.obfuscate',
'minify.ignore','minify.enable_directive_replacement','minify.directives.@','minify.keep_directives','octane.server',
...
'octane.max_execution_time','profanity.replaceFullWords','profanity.replaceWith','profanity.strReplace.a','profanity.strReplace.b',
'profanity.strReplace.c','profanity.strReplace.d','profanity.strReplace.e','profanity.strReplace.f','profanity.strReplace.g',
'profanity.strReplace.h','profanity.strReplace.i','profanity.strReplace.j','profanity.strReplace.k','profanity.strReplace.l',
'profanity.strReplace.m','profanity.strReplace.n','profanity.strReplace.o','profanity.strReplace.p','profanity.strReplace.q',
'profanity.strReplace.r','profanity.strReplace.s','profanity.strReplace.t','profanity.strReplace.u','profanity.strReplace.v',
'profanity.strReplace.w','profanity.strReplace.x','profanity.strReplace.y','profanity.strReplace.z','profanity.defaults',
...
'queue.failed.driver','queue.failed.database','queue.failed.table','responsecache.enabled','responsecache.cache_profile',
...
'responsecache.hasher','responsecache.serializer','reverb.default','reverb.servers.reverb.host','reverb.servers.reverb.port',
...
'scout.meilisearch.host','scout.meilisearch.key','scout.meilisearch.index-settings.App\\Models\\User.filterableAttributes','scout.meilisearch.index-settings.App\\Models\\User.sortableAttributes','scout.meilisearch.index-settings.App\\Models\\Item.filterableAttributes',
'scout.meilisearch.index-settings.App\\Models\\Item.sortableAttributes','scout.meilisearch.index-settings.App\\Models\\Space.filterableAttributes','scout.meilisearch.index-settings.App\\Models\\Space.sortableAttributes','scout.meilisearch.index-settings.App\\Models\\ForumThread.filterableAttributes','scout.meilisearch.index-settings.App\\Models\\ForumThread.sortableAttributes',
...
'scout.typesense.client-settings.healthcheck_interval_seconds','scout.typesense.client-settings.num_retries','scout.typesense.client-settings.retry_interval_seconds','scout.typesense.model-settings','search_routes.0.name',
'search_routes.0.keywords','search_routes.0.url','search_routes.0.description','search_routes.0.type','search_routes.0.icon',
'search_routes.1.name','search_routes.1.keywords','search_routes.1.url','search_routes.1.description','search_routes.1.type',
'search_routes.1.icon','search_routes.2.name','search_routes.2.keywords','search_routes.2.url','search_routes.2.description',
'search_routes.2.type','search_routes.2.icon','services.mailtrap-sdk.host','services.mailtrap-sdk.apiKey','services.mailtrap-sdk.inboxId',
...
'services.mailgun.scheme','services.github.client_id','services.github.client_secret','services.github.redirect','services.discord.client_id',
'services.discord.client_secret','services.discord.redirect','services.discord.allow_gif_avatars','services.discord.avatar_default_extension','services.google.client_id',
'services.google.client_secret','services.google.redirect','services.stripe.key','services.stripe.secret','session.driver',
...
'swagger-ui.files.0.oauth.authorization_path','swagger-ui.files.0.oauth.client_id','swagger-ui.files.0.oauth.client_secret','swagger-ui.files.0.stylesheet','telescope.enabled',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\GateWatcher.ignore_packages','telescope.watchers.Laravel\\Telescope\\Watchers\\GateWatcher.ignore_paths','telescope.watchers.Laravel\\Telescope\\Watchers\\JobWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\LogWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\MailWatcher',
...
'themes.default','themes.roster.light.name','themes.roster.light.lowercase','themes.roster.light.file','themes.roster.light.available',
'themes.roster.dark.name','themes.roster.dark.lowercase','themes.roster.dark.file','themes.roster.dark.available','themes.roster.amoled.name',
'themes.roster.amoled.lowercase','themes.roster.amoled.file','themes.roster.amoled.available','themes.roster.vistora.name','themes.roster.vistora.lowercase',
'themes.roster.vistora.file','themes.roster.vistora.available','themes.roster.discord.name','themes.roster.discord.lowercase','themes.roster.discord.file',
'themes.roster.discord.available','themes.roster.halloween.name','themes.roster.halloween.lowercase','themes.roster.halloween.file','themes.roster.halloween.available',
'themes.roster.holiday.name','themes.roster.holiday.lowercase','themes.roster.holiday.file','themes.roster.holiday.available','themes.roster.classic.name',
'themes.roster.classic.lowercase','themes.roster.classic.file','themes.roster.classic.available','varnish.host','varnish.administrative_secret',
'varnish.administrative_port','varnish.cache_time_in_minutes','varnish.cacheable_header_name','concurrency.default','view.paths',
...
'debugbar.route_domain','debugbar.theme','debugbar.debug_backtrace_limit','passport.guard','passport.private_key',
...
'purifier.settings.custom_definition.debug','purifier.settings.custom_definition.elements.0','purifier.settings.custom_definition.elements.1','purifier.settings.custom_definition.elements.2','purifier.settings.custom_definition.elements.3',
'purifier.settings.custom_definition.elements.4','purifier.settings.custom_definition.elements.5','purifier.settings.custom_definition.elements.6','purifier.settings.custom_definition.elements.7','purifier.settings.custom_definition.elements.8',
'purifier.settings.custom_definition.elements.9','purifier.settings.custom_definition.elements.10','purifier.settings.custom_definition.elements.10.4.src','purifier.settings.custom_definition.elements.10.4.type','purifier.settings.custom_definition.elements.10.4.width',
'purifier.settings.custom_definition.elements.10.4.height','purifier.settings.custom_definition.elements.10.4.poster','purifier.settings.custom_definition.elements.10.4.preload','purifier.settings.custom_definition.elements.10.4.controls','purifier.settings.custom_definition.elements.11',
'purifier.settings.custom_definition.elements.11.4.src','purifier.settings.custom_definition.elements.11.4.type','purifier.settings.custom_definition.elements.12','purifier.settings.custom_definition.elements.13','purifier.settings.custom_definition.elements.14',
'purifier.settings.custom_definition.elements.15','purifier.settings.custom_definition.elements.16','purifier.settings.custom_definition.elements.17','purifier.settings.custom_definition.elements.18','purifier.settings.custom_definition.elements.18.4.cite',
'purifier.settings.custom_definition.elements.18.4.datetime','purifier.settings.custom_definition.elements.19','purifier.settings.custom_definition.elements.19.4.cite','purifier.settings.custom_definition.elements.19.4.datetime','purifier.settings.custom_definition.attributes.0',
'purifier.settings.custom_definition.attributes.1','purifier.settings.custom_definition.attributes.2','purifier.settings.custom_definition.attributes.3','purifier.settings.custom_definition.attributes.4','purifier.settings.custom_definition.attributes.5',
'purifier.settings.custom_definition.attributes.6','purifier.settings.custom_attributes.0','purifier.settings.custom_elements.0','laravelcloudflare.enabled','laravelcloudflare.replace_ip',
'laravelcloudflare.cache','laravelcloudflare.url','laravelcloudflare.ipv4-path','laravelcloudflare.ipv6-path','json-api-paginate.max_results',
'json-api-paginate.default_size','json-api-paginate.number_parameter','json-api-paginate.size_parameter','json-api-paginate.cursor_parameter','json-api-paginate.method_name',
'json-api-paginate.use_simple_pagination','json-api-paginate.use_cursor_pagination','json-api-paginate.use_fast_pagination','json-api-paginate.base_url','json-api-paginate.pagination_parameter',
...
'chat.validate','subscription.checkout','purchase.success','purchase.cancelled','acheivements',
'notification.page','notification.view','auth.logout','auth.language','auth.login.google.auth',
'auth.login.google.validation','auth.login.discord.auth','auth.login.discord.validation','auth.login.page','auth.login.validate',
'auth.login.metamask','auth.login.metamask.validation','auth.register.page','auth.register.validate','auth.forgot.page',
'auth.forgot.password.reset','auth.forgot.password.email','password.confirm.form','password.confirm','welcome.page',
...
'membership.page','membership.purchase','search.page','develop.page','spaces.page',
'spaces.create.page','spaces.create.validate','spaces.membership','spaces.view','verification.notice',
'verification.verify','verification.send','policies.tos','policies.privacy','admin.page',
