...
'chat.validate','acheivements','notification.page','notification.view',
'auth.logout','auth.language','auth.login.google','auth.login.google.validation','auth.login.page',
'auth.login.validate','auth.login.metamask','auth.login.metamask.validation','auth.register.page','auth.register.validate',
'auth.forgot.page','auth.forgot.password.reset','auth.forgot.password.email','Welcome',
'games.page','games.game','removed','store.page','store.create.page',
'store.create.validate','store.item','store.edit','store.edit.validate','store.purchase',
'membership.page','membership.purchase','develop.page','develop.create.page','develop.create.validate',
'develop.item','develop.purchase','spaces.page','spaces.create.page','spaces.create.validate',
'spaces.membership','spaces.view','verification.notice','verification.verify','verification.send',
'admin.page','admin.users.page','admin.users.manage-user','admin.users.gift-user','admin.items.page',
'admin.items.manage-item','admin.items.create.create-item','admin.items.create.validate','admin.messaging.page','admin.messaging.validate',
'admin.reports.page','admin.reports.view','admin.assets.approve',);
